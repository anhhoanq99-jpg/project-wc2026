...
let bonusCache = 0; // điểm thưởng quản trị (chỉ có khi đăng nhập)
...
export function enterServerMode(profile: Profile, predictions: Prediction[], bonus = 0) {
  serverMode = true;
...
/** Điểm thưởng quản trị của người đang đăng nhập (ẩn danh = 0). */
